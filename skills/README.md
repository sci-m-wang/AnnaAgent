...
ClawHub can ingest the skill folder directly from the GitHub repository or from a
packaged archive that preserves `SKILL.md` and the `references/` directory.
